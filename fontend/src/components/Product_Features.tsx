...
export default function Product_Features() {
    return (
        <div className="bg-white dark:bg-[#0F0F12]">
            <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl">Technical Specifications</h2>
                    ...
                    <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
                        {features.map((feature) => (
                            <div key={feature.name} className="border-t border-gray-200 pt-4">
                                ...
                                <dd className="mt-2 text-sm text-gray-700 dark:text-gray-300">{feature.description}</dd>
                            </div>
                        ))}
                    </dl>
                </div>
