...
export default function Promo_Sections() {
    return (
        <div className=" relative overflow-hidden bg-white dark:bg-[#0F0F12]  z-0">
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                    ...
                    <div>
                        <div className="mt-10 ">
                            ...
                            <Link
                                href="#"
                                className="inline-block rounded-md border border-[#1F1F23] px-8 py-3 text-center font-medium dark:bg-gray-800 bg-primary text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100"
                            >
                                Shop Collection
                            </Link>
                        </div>
